...
const handleForgotPassword = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield fetch(`${BASE_URL}/users/forgot-password`, {
            method: 'POST',
...
const handleOTPVerification = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield fetch(`${BASE_URL}/users/checkcode`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
